...
Процедура ЗаполнитьПоШаблону()          
	...
	ЕАС_ЗаполнениеОтчетовКопируемый.ВыполнитьАлгоритмБезопасно(Объект, Алгоритмы.АлгоритмНачальногоЗаполненияШаблона, НачальнаяТаблица, СтруктураСтроки, ВыборкаПолейШаблона);
				...
				Если ОписаниеОбласти <> Неопределено Тогда
					...
					Если ИмяПараметра <> Неопределено Тогда
						...
						Если ЗначениеЗаполнено(АлгоритмРасчетаЯчейки) Тогда
							...
							ЕАС_ЗаполнениеОтчетовКопируемый.ВыполнитьАлгоритмБезопасно(Объект, АлгоритмРасчетаЯчейки, НачальнаяТаблица, СтруктураСтроки, ВыборкаПолейШаблона);
	...
	ЕАС_ЗаполнениеОтчетовКопируемый.ВыполнитьАлгоритмБезопасно(Объект, Алгоритмы.АлгоритмЗавершенияЗаполненияШаблона, НачальнаяТаблица, СтруктураСтроки, ВыборкаПолейШаблона);
