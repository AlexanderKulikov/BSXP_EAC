...
Процедура ОтладкаЖивотноводство2019(Объект, НачальнаяТаблица, СтруктураСтроки, ВыборкаПолейШаблона) Экспорт
	...
	Для НомерГода = 2019 По 2020 Цикл
		...
		ЗапросСП51.Текст = "ВЫБРАТЬ
						   ...
						   |	ГДЕ 
						   |		ЖивотныеНаВыращивании.Номенклатура.ВидНоменклатуры В (&ВидыНоменклатуры)
		                   |	
		                   |	СГРУППИРОВАТЬ ПО
						   ...
						   |	ГДЕ 
						   |		ОсновныеСредства.Номенклатура.ВидНоменклатуры В (&ВидыНоменклатуры)
		                   |	
		                   |	СГРУППИРОВАТЬ ПО
		                   |		ОсновныеСредства.Номенклатура
		                   |	
						   ...
						   |	ГДЕ 
						   |		ЖивотныеНаВыращиванииБезСклада.Номенклатура.ВидНоменклатуры В (&ВидыНоменклатуры)
		                   |	
		                   |	СГРУППИРОВАТЬ ПО
