...
Процедура ОтладкаЖивотноводство2019(Объект, НачальнаяТаблица, СтруктураСтроки, ВыборкаПолейШаблона) Экспорт
	...
	Для НомерГода = 2019 По 2020 Цикл
		...
		ЕАС_ЗаполнениеОтчетовКопируемый.УстановитьРезультатВычисления(НачальнаяТаблица, СтруктураСтроки, ИтогоРеализованоМясаГовядины/100, Ложь);
		...
		СтрокаВыручки = ЕАС_ЗаполнениеОтчетовКопируемый.УстановитьРезультатВычисления(НачальнаяТаблица, СтруктураСтроки, ИтогоВыручкаМяса/1000, Ложь);
		...
		СтрокаСебестоимость = ЕАС_ЗаполнениеОтчетовКопируемый.УстановитьРезультатВычисления(НачальнаяТаблица, СтруктураСтроки, ИтогоСебестоимостьМяса / 1000, Ложь);
